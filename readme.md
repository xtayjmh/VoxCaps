...
-   **动态状态岛**：随客户端自动启动，录音、识别、送达和异常均有桌面动画提示；短按 CapsLock 不闪烁，也不需要额外启动辅助程序。
...
同时感谢 Google Antigravity、Anthropic Claude、GLM、DeepSeek 等编程助手为原项目与本分支开发提供帮助。
...
| 微信支付 | 支付宝 |
| --- | --- |
| ![VoxCaps 微信赞助](assets/sponsor-wechat.jpg) | ![VoxCaps 支付宝赞助](assets/sponsor-alipay.jpg) |
